...
RACE_CONDITION_PATTERNS = [
    ...
    TestPattern(
        ...
        endpoint_patterns=[r"/coupon", r"/promo", r"/discount", r"/voucher", r"/redeem"],
    ...
    TestPattern(
        ...
        endpoint_patterns=[r"/bonus", r"/reward", r"/claim", r"/redeem", r"/spin"],
    ...
    TestPattern(
        ...
        endpoint_patterns=[r"/vote", r"/like", r"/upvote", r"/rate"],
    ...
    TestPattern(
        ...
        endpoint_patterns=[r"/reset", r"/password", r"/forgot"],
        ...
        test_cases=[
            TestCase(
                ...
                body_template={"token": "{{reset_token}}", "new_password": "NewPass123!"},
